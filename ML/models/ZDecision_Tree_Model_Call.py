...
dt_model_final = joblib.load(r"crop_prediction\filetest2.pkl")

# Get the input parameters as command line arguments
if len(sys.argv) != 4:
    print("Usage: python yield_prediction\yield_prediction.py <state> <district> <season>")
    sys.exit(1)
...
print("Prediction: ", max(Predict_dict, key=Predict_dict.get))
print("Accuracy: ", Predict_dict[max(Predict_dict, key=Predict_dict.get)])
